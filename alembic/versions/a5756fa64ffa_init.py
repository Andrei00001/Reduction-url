...
Revision ID: a5756fa64ffa
Revises: 
Create Date: 2023-01-21 00:15:42.611579
...
def upgrade() -> None:
    ...
    op.add_column('auth_user', sa.Column('prefix', sa.String(length=12), nullable=False))
    ...
    op.alter_column('url', 'url',
               ...
               nullable=True)
    op.alter_column('url', 'reduction_url',
               existing_type=sa.VARCHAR(length=2048),
               nullable=True)
    op.drop_index('url_reduction_url_d659a346_like', table_name='url')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index('url_reduction_url_d659a346_like', 'url', ['reduction_url'], unique=False)
    op.alter_column('url', 'reduction_url',
               existing_type=sa.VARCHAR(length=2048),
               nullable=False)
    op.alter_column('url', 'url',
    ...
    op.alter_column('auth_user', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.drop_column('auth_user', 'prefix')
